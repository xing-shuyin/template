        ...
        <el-dialog class="admin_detail_dialog" v-model="attrs.current_show" :append-to-body="false" :show-close="false"
            ...
            <el-form :model="attrs.current" label-width="120px" ref="form" :rules="rules">
                ...
                <el-form-item label="标签" prop="label">
                    <el-input v-model="attrs.current.label" />
                </el-form-item>
                <el-form-item label="名称" prop="name">
                    <el-input v-model="attrs.current.name" />
                </el-form-item>
                <el-form-item label="图标" prop="icon">
                    <el-input v-model="attrs.current.icon" />
                    <f-icon-panel v-model="attrs.current.icon" />
                </el-form-item>
                <el-form-item label="路径" prop="path">
                    <el-input v-model="attrs.current.path" />
                </el-form-item>
                <el-form-item label="组件" prop="component">
                    <el-input v-model="attrs.current.component" />
                </el-form-item>
                <el-form-item label="排序" prop="sort">
                    <el-input v-model="attrs.current.sort" />
                </el-form-item>
                <el-form-item label="链接" prop="is_link">
                    <el-switch v-model="attrs.current.is_link" />
                </el-form-item>
                <el-form-item label="文件夹" prop="is_catalog">
                    <el-switch v-model="attrs.current.is_catalog" />
                </el-form-item>
            </el-form>
            <template #footer>
...
const attrs = reactive({
    ...
    total: 0,
    columns: [
        { type: 'text', width: 'auto', label: '标签', prop: 'label', align: "left", show: true, },
        { type: 'text', width: 'auto', label: '名称', prop: 'name', align: "center", show: true, },
        { type: 'iconify', width: 'auto', label: '图标', prop: 'icon', align: "center", show: true, },
        { type: 'text', width: 'auto', label: '路径', prop: 'path', align: "center", show: true, },
        { type: 'text', width: 'auto', label: '组件', prop: 'component', align: "center", show: true, },
        { type: 'text', width: 'auto', label: '排序', prop: 'sort', align: "center", show: true, },
        { type: 'text', width: 'auto', label: '链接', prop: 'is_link', align: "center", show: true, },
        { type: 'text', width: 'auto', label: '文件夹', prop: 'is_catalog', align: "center", show: true, },
