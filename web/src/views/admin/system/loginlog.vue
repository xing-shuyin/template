...
const attrs = reactive({
    ...
    total: 0,
    columns: [
        { type: 'text', width: 'auto', label: 'user_id', prop: 'user_id', align: "center", show: true, },
        { type: 'text', width: 180, label: 'username', prop: 'username', align: "center", show: true },
        { type: 'text', width: 180, label: 'ip', prop: 'ip', align: "center", show: true, },
        { type: 'text', width: 180, label: 'user_agent', prop: 'user_agent', align: "center", show: true, },
